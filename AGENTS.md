...
1. **vc.ru**: открыть «Аналитику» по каждой статье (кабинет автора) — снять реальные цифры: уникальные читатели, дочитывания. Сравнить с pageviews на карточке (328/125/90)
...
5. **Habr**: ПАУЗА (решение принято) — не публиковать, пока не будете готовы писать текст руками без ИИ
