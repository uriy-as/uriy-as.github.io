...
- 🚫 **VC.RU ЛИМИТ ПОСТОВ**: 4-я статья («Сколько стоит поддержка сайта», `vcru-website-care.md`) **НЕ пропущена** — «вы исчерпали лимит коммерческих постов». Бесплатный коммерческий аккаунт = лимит ~3 поста. Итого потолок без Pro достигнут. Текст 4-й статьи готов, ждёт публикации (когда: Pro / сброс лимита / не-коммерческий пост)

## Что делать завтра (07.09.2026) — по приоритету
1. **vc.ru — решить вопрос с Pro-подпиской** (уведомление о неиндексации/скрытии из дистрибуции). Проверить рек на #3
2. Ежедневная проверка статов: Dev.to + Medium + посещения + vc.ru рек
3. **Habr**: опубликовать по `habr-sales-bot-draft.md` (ручная публикация с VPN)
4. **Medium**: подача в публикации (Better Programming, Towards Dev) — 0 подписчиков = 0 раздачи
5. Крипто-кошелёк (Binance), каталоги (Google Business Profile, 2GIS, Clutch)
6. Следить за индексацией Dev.to #7/#8 (7–14 дней с публикации ≈ 10–17.09)

## Список статей vc.ru (актуально)
1. «Как построить воронку продаж в Telegram-боте» → https://vc.ru/id6095617/3119787-kak-postroit-voronku-prodazh-v-telegram-bote-ot-pervogo-soobsheniya-do-oplaty-v-chate (58 рек)
2. «10 ошибок на сайте, которые убивают конверсию» → https://vc.ru/telegram/3122698-oshibki-na-sayte-kotorye-ubivayut-konversiyu (**228 рек**) — лидер всех площадок
3. «Сколько стоит сайт в 2026: реальные цены и на чём вас разводят» → https://vc.ru/id6095617/3123730-skolko-stoit-sajt-ceny-i-lovushki (7 рек)
